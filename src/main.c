		     ...
		     GtkWidget **ppwTabArgs)
{
   ...
   /* on realise le calcul sur l'image */
	 int classe = gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(ppwTabArgs[6]));
	 int threshold = gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(ppwTabArgs[7]));
	 ComputeImage(pucImaOrig,NbLine,NbCol,pucImaRes, classe, threshold);
...
int main (int argc, char **argv)
{
  ...
  GtkWidget *pwButtonQuit;
	...
	/*label classe et threshold*/
	GtkWidget *pwButtonClasse;
	GtkWidget *pwButtonThreshold;
  ...
  gtk_table_attach_defaults(GTK_TABLE(pwTabShowOrig), pwButtonBoxOpen,
	...
	GtkWidget *pwButtonClass = gtk_hbutton_box_new();
	gtk_table_attach_defaults(GTK_TABLE(pwTabShowOrig), pwButtonClass,
	   			0,1,10,20);
  ...
  gtk_container_add(GTK_CONTAINER(pwButtonBoxOpen),pwButtonOpen);
	...
	/*le bouton de classe*/
	pwButtonClasse= gtk_label_new("Class:");
	pwButtonThreshold= gtk_label_new("Threshold:");
	GtkWidget *pwButtonSpinClass = gtk_spin_button_new (GTK_ADJUSTMENT(gtk_adjustment_new (8, 0.0, 100.0, 1.0, 5.0, 0.0)), 1.0, 0);
	GtkWidget *pwButtonSpinThreshold = gtk_spin_button_new (GTK_ADJUSTMENT(gtk_adjustment_new (7, 0.0, 100, 1.0, 5.0, 0.0)), 1.0, 0);
	gtk_container_add(GTK_CONTAINER(pwButtonClass),pwButtonClasse);
	gtk_container_add(GTK_CONTAINER(pwButtonClass),pwButtonSpinClass);
	gtk_container_add(GTK_CONTAINER(pwButtonClass),pwButtonThreshold);
	gtk_container_add(GTK_CONTAINER(pwButtonClass),pwButtonSpinThreshold);
	ppwTabArgs[6]=pwButtonSpinClass;
	ppwTabArgs[7]=pwButtonSpinThreshold;
